const DateSmall = require('./date-small')

describe('DateSmall', () => {
  it('should create a DateSmall instance with the provided month, day and year', () => {
    const month = 9
    const day = 27
    const year = 1987
    const expectedValue = year * 512 + month * 32 + day

    const date = new DateSmall(month, day, year)

    expect(date.value).toBe(expectedValue)
  })

  describe('.month()', () => {
    it('should return the month', () => {
      const expectedMonth = 9
      const date1 = new DateSmall(9, 27, 1987)
  ...
  describe('.equals()', () => {
    ...
    it('should return false when objects have different day', () => {
      const targetDate = new DateSmall(
