...
class ThreeSumFastClient {
   ...
   * ```sh
   * $ ./client ThreeSumFastClient algs4-data/1Kints.txt
   * 70
   * ```
   * @example <caption>2K ints</caption>
   * ```sh
   * $ ./client ThreeSumFastClient algs4-data/2Kints.txt
   * 528
   * ```
   * @example <caption>4K ints</caption>
   * ```sh
   * $ ./client ThreeSumFastClient algs4-data/4Kints.txt
   * 4039
   * ```
...
module.exports = { ThreeSumFastClient }
