...
class WeightedQuickUnionUFClient {
   ...
   * ```sh
   * $ ./client WeightedQuickUnionUFClient < algs4-data/tinyUF.txt
   * 4 3
   * 3 8
   * 6 5
   * 9 4
   ...
   * ```sh
   * $ ./client WeightedQuickUnionUFClient < algs4-data/largeUF.txt
   * 786321 134521
   * 696834 98245
   * 135991 549478
   * 44723 265931
...
module.exports = { WeightedQuickUnionUFClient }
