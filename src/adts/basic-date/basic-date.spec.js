const BasicDate = require('./basic-date')

describe('Unit Tests: BasicDate ADT', () => {
  it('should create a BasicDate instance with the provided month, day and year', () => {
    const month = 9
    const day = 27
    const year = 1987

    const date = new BasicDate(month, day, year)
  ...
  describe('instance', () => {
    describe('month()', () => {
      it('should return the `month`', () => {
        ...
        const date1 = new BasicDate(9, 27, 1987)
        const date2 = new BasicDate('9/27/1987')
    ...
    describe('equals()', () => {
      beforeEach(() => {
        this.sourceDate = new BasicDate(9, 27, 1987)
      })
